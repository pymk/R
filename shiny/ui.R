...
ui <- shiny::fluidPage(
  ...
  # shiny::textInput(inputId = "text_input", label = "Click the Button", value = "", width = "auto", placeholder = "Hint goes here"),

  shiny::sidebarLayout(
    # Side panel
    sidebarPanel = shiny::sidebarPanel(
      shiny::div(
        # shiny::actionButton(inputId = "icon_clean", label = "Clean", icon = shiny::icon(name = "shower", lib = "font-awesome"), width = "auto"),
        # shiny::actionButton(inputId = "icon_dirty", label = "Dirty", icon = shiny::icon(name = "heart", lib = "font-awesome"), width = "auto"),
        # shiny::hr(),
